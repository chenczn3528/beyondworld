        ...
        >
            ...
            >
                <div style={{marginTop: `${baseSize * 10}px`, marginLeft: `${baseSize * 10}px`, marginRight: `${baseSize * 10}px`}}>
                    <iframe
                        frameborder="no" border="0" marginwidth="0" marginheight="0" width={`${baseSize * 280}px`} height="86"
                ...
                <div
                    ...
                    style={{marginBottom: `${baseSize * 10}px`, marginLeft: `${baseSize * 10}px`, marginRight: `${baseSize * 10}px`}}
                >
                                ...
                                <React.Fragment key={id}>
                                    ...
                                    >
                                        <div style={{display: "flex", flexDirection: "column", gap: `${baseSize * 4}px`}}>
                                            ...
                                            >
                                                <span style={{flex: 3, minWidth: 0}}>{char["title"]}</span>
                                                <span
                                                    style={{
                                                        fontSize: `${baseSize * 6}px`,

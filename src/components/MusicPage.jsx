            ...
            >
                <div style={{marginTop: `${baseSize * 10}px`, marginLeft: `${baseSize * 10}px`, marginRight: `${baseSize * 10}px`}}>
                    <iframe
                        ...
                        src={`//music.163.com/outchain/player?type=2&id=${musicID}&auto=1&height=66`}>
                    </iframe>
                </div>
                ...
                <label
                    ...
                    只能选一首歌循环播放，不能自己设置多首歌顺序播放。有些浏览器可能会限制音频的播放数量，同时播放超过一个音频会被打断。
                </label>
                ...
                >
                    <div className="flex grid grid-cols-1 gap-[3vmin]">
                        {songsList.map((char) => {
